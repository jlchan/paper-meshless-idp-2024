...
% directory = '/Users/SamuelKwan/Documents/Rice/Research CAAM/Meshless/Matrices/errors_1';
% save(fullfile(directory, 'diff_1_75_75_250.mat'), 'x_diff_1', 'y_diff_1');
...
% directory = '/Users/SamuelKwan/Documents/Rice/Research CAAM/Meshless/Matrices/errors_func';
% save(fullfile(directory, 'diff_func_75_75_250.mat'), 'x_diff_func', 'y_diff_func');
%%
...
sqrt(sum(H_min(ext).*(x_diff_1(ext).^2)));
sqrt(sum(H_min(ext).*(y_diff_1(ext).^2)));

sqrt(sum(H_min(int).*(x_diff_1(int).^2)));
sqrt(sum(H_min(int).*(y_diff_1(int).^2)));
...
% directory = '/Users/SamuelKwan/Documents/Rice/Research CAAM/Meshless/Matrices/errors_1';
% save(fullfile(directory, 'diff_1_unweighted_75_75_250.mat'), 'x_diff_1', 'y_diff_1');
...
% directory = '/Users/SamuelKwan/Documents/Rice/Research CAAM/Meshless/Matrices/errors_func';
% save(fullfile(directory, 'diff_func_unweighted_75_75_250.mat'), 'x_diff_func', 'y_diff_func');
%%
